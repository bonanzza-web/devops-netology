...
| `d`  | 1+2  | результат будет "1+2" т.к. переменной присвоена строка со значениями переменных a и b |
| `e`  |  3  | результат будет "3" т.к. переменной присвоено значение операции сложения переменных a и b |
